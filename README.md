...
## Detection Status
> [!NOTE]  
> If your tooling isn't covered please create an issue with the vendor, tool, and detection status. Detection status is evaluated over RDP (i.e. no smbexec, wmiexec, etc).
